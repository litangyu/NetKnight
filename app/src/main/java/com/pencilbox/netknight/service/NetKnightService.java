...
//                        .addAddress(VPN_ADDRESS, 32).addAllowedApplication("com.devjiang")
...
//        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            mInterface = builder.setSession("NetKnight").setBlocking(false).addAddress
                    (VPN_ADDRESS, 32).addRoute("0.0.0.0", 0).establish();
        } else {
...
//                        mHandler.sendEmptyMessage(MSG_STOP_VPN_SERVICE);
                ...
                if (inputSize > 0) {
                    ...
                    MyLog.logd(this, "--------data read----------size:" + packet2net
                            .getPayloadSize());
                    ...
                    if (packet2net.isTCP()) {
                        ...
                        String ipAndPort = desAddress.getHostAddress() + ":" + sourcePort + ":" +
                                desPort;
